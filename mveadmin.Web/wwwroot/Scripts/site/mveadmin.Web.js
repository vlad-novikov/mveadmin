...
(function (Mveadmin) {
    ...
    })(Administration = Mveadmin.Administration || (Mveadmin.Administration = {}));
})(Mveadmin || (Mveadmin = {}));
var Mveadmin;
(function (Mveadmin) {
    var Administration;
...
(function (Mveadmin) {
    ...
    })(BasicSamples = Mveadmin.BasicSamples || (Mveadmin.BasicSamples = {}));
})(Mveadmin || (Mveadmin = {}));
var Mveadmin;
(function (Mveadmin) {
    var BasicSamples;
        ...
        var FilteredLookupInDetailForm = /** @class */ (function (_super) {
            ...
            function FilteredLookupInDetailForm(prefix) {
                ...
                if (!FilteredLookupInDetailForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Mveadmin.Northwind.CustomerEditor;
                    var w1 = s.DateEditor;
        ...
        var PopulateLinkedDataForm = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataForm(prefix) {
                ...
                if (!PopulateLinkedDataForm.init) {
                    ...
                    var w2 = s.DateEditor;
                    var w3 = s.LookupEditor;
                    var w4 = Mveadmin.Northwind.OrderDetailsEditor;
        ...
        var StaticTextBlockForm = /** @class */ (function (_super) {
            ...
            function StaticTextBlockForm(prefix) {
                ...
                if (!StaticTextBlockForm.init) {
                    ...
                    var s = Serenity;
                    var w0 = Mveadmin.StaticTextBlock;
                    var w1 = s.StringEditor;
...
(function (Mveadmin) {
    ...
    })(Membership = Mveadmin.Membership || (Mveadmin.Membership = {}));
})(Mveadmin || (Mveadmin = {}));
var Mveadmin;
(function (Mveadmin) {
    var Membership;
...
(function (Mveadmin) {
    ...
    })(Northwind = Mveadmin.Northwind || (Mveadmin.Northwind = {}));
})(Mveadmin || (Mveadmin = {}));
var Mveadmin;
(function (Mveadmin) {
    var Northwind;
...
(function (Mveadmin) {
    ...
    (function (Northwind) {
        ...
        Serenity.Decorators.registerEnumType(Gender, 'Mveadmin.Northwind.Gender', 'Mveadmin.Northwind.Entities.Gender');
    })(Northwind = Mveadmin.Northwind || (Mveadmin.Northwind = {}));
})(Mveadmin || (Mveadmin = {}));
var Mveadmin;
(function (Mveadmin) {
...
(function (Mveadmin) {
    ...
    (function (LanguageList) {
        function getValue() {
            var result = [];
            for (var _i = 0, _a = Mveadmin.Administration.LanguageRow.getLookup().items; _i < _a.length; _i++) {
                var k = _a[_i];
                if (k.LanguageId !== 'en') {
    ...
    })(LanguageList = Mveadmin.LanguageList || (Mveadmin.LanguageList = {}));
})(Mveadmin || (Mveadmin = {}));
...
(function (Mveadmin) {
    ...
    (function (ScriptInitialization) {
        ...
        Serenity.EntityDialog.defaultLanguageList = Mveadmin.LanguageList.getValue;
        if ($.fn['colorbox']) {
            $.fn['colorbox'].settings.maxWidth = "95%";
            $.fn['colorbox'].settings.maxHeight = "95%";
        }
        window.onerror = Q.ErrorHandling.runtimeErrorHandler;
    })(ScriptInitialization = Mveadmin.ScriptInitialization || (Mveadmin.ScriptInitialization = {}));
})(Mveadmin || (Mveadmin = {}));
var Mveadmin;
(function (Mveadmin) {
    var Administration;
...
(function (Mveadmin) {
    ...
    Mveadmin.BasicProgressDialog = BasicProgressDialog;
})(Mveadmin || (Mveadmin = {}));
var Mveadmin;
(function (Mveadmin) {
    var Common;
    (function (Common) {
        var BulkServiceAction = /** @class */ (function () {
            ...
            BulkServiceAction.prototype.createProgressDialog = function () {
                this.progressDialog = new Mveadmin.BasicProgressDialog();
...
(function (Mveadmin) {
    ...
    })(DialogUtils = Mveadmin.DialogUtils || (Mveadmin.DialogUtils = {}));
})(Mveadmin || (Mveadmin = {}));
var Mveadmin;
(function (Mveadmin) {
    var Common;
...
(function (Mveadmin) {
    ...
    Mveadmin.StaticTextBlock = StaticTextBlock;
})(Mveadmin || (Mveadmin = {}));
var Mveadmin;
(function (Mveadmin) {
    var Common;
    ...
    (function (Northwind) {
        var CustomerDialog = /** @class */ (function (_super) {
            ...
            function CustomerDialog() {
                ...
                Mveadmin.DialogUtils.pendingChangesConfirmation(_this.element, function () { return _this.getSaveState() != _this.loadedState; });
                return _this;
            }
    ...
    (function (Northwind) {
        var CustomerGrid = /** @class */ (function (_super) {
            ...
            CustomerGrid.prototype.getButtons = function () {
                ...
                buttons.push(Mveadmin.Common.ExcelExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); },
                    service: 'Northwind/Customer/ListExcel',
                    separator: true
                }));
                buttons.push(Mveadmin.Common.PdfExportHelper.createToolButton({
                    grid: this,
                    onViewSubmit: function () { return _this.onViewSubmit(); }
                }));
                return buttons;
    ...
    (function (Northwind) {
        var OrderDialog = /** @class */ (function (_super) {
            ...
            OrderDialog.prototype.getToolbarButtons = function () {
                var _this = this;
                var buttons = _super.prototype.getToolbarButtons.call(this);
                buttons.push(Mveadmin.Common.ReportHelper.createToolButton({
                    title: 'Invoice',
                    cssClass: 'export-pdf-button',
            ...
            OrderGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('print-invoice')) {
                        Mveadmin.Common.ReportHelper.execute({
                            reportKey: 'Northwind.OrderDetail',
                            params: {
            ...
            NotesEditor.prototype.addClick = function () {
                ...
                dlg.okClick = function () {
                    ...
                    Q.insert(_this.items, 0, {
                        Text: text,
                        InsertUserDisplayName: Mveadmin.Authorization.userDefinition.DisplayName,
...
(function (Mveadmin) {
    ...
    (function (Northwind) {
        ...
        }(Mveadmin.Common.GridEditorDialog));
...
(function (Mveadmin) {
    ...
    (function (Northwind) {
        ...
        }(Mveadmin.Common.GridEditorBase));
    ...
    (function (Northwind) {
        var RegionDialog = /** @class */ (function (_super) {
            ...
            RegionDialog.prototype.getLanguages = function () {
                return Mveadmin.LanguageList.getValue();
            };
...
(function (Mveadmin) {
    ...
    })(Authorization = Mveadmin.Authorization || (Mveadmin.Authorization = {}));
})(Mveadmin || (Mveadmin = {}));
var Mveadmin;
(function (Mveadmin) {
    var BasicSamples;
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        ...
        }(Mveadmin.Northwind.ProductDialog));
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        ...
        }(Mveadmin.Northwind.ProductGrid));
        ...
        var DefaultValuesInNewGrid = /** @class */ (function (_super) {
            ...
            DefaultValuesInNewGrid.prototype.addButtonClick = function () {
                this.editItem({
                    ...
                    EmployeeID: Mveadmin.Northwind.EmployeeRow.getLookup().items
                        .filter(function (x) { return x.FullName === 'Robert King'; })[0].EmployeeID,
                    ShipVia: Mveadmin.Northwind.ShipperRow.getLookup().items
            ...
            DefaultValuesInNewGrid.prototype.getButtons = function () {
                ...
                buttons.push({
                    ...
                    onClick: function () {
                        ...
                        var dlg = new Mveadmin.Northwind.OrderDialog();
                        ...
                        var chai = Mveadmin.Northwind.ProductRow.getLookup().items
                            .filter(function (x) { return x.ProductName === 'Chai'; })[0];
                        // LoadEntityAndOpenDialog, loads an OrderRow 
                        // to dialog and opens it
                        var lauraCallahanID = Mveadmin.Northwind.EmployeeRow.getLookup().items
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        ...
        }(Mveadmin.Northwind.OrderDialog));
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        var GetInsertedRecordIdDialog = /** @class */ (function (_super) {
            ...
            GetInsertedRecordIdDialog.prototype.onSaveSuccess = function (response) {
                ...
                if (this.isNew()) {
                    ...
                    Mveadmin.Northwind.CategoryService.Retrieve({
        ...
        }(Mveadmin.Northwind.CategoryDialog));
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        ...
        }(Mveadmin.Northwind.CategoryGrid));
        ...
        var OtherFormInTabDialog = /** @class */ (function (_super) {
            ...
            function OtherFormInTabDialog() {
                ...
                _this.customerPropertyGrid = new Serenity.PropertyGrid(_this.byId("CustomerPropertyGrid"), {
                    ...
                    items: Q.getForm(Mveadmin.Northwind.CustomerForm.formKey).filter(function (x) { return x.name != 'CustomerID'; }),
                    useCategories: true
                });
                // this is just a helper to access editors if needed
                _this.customerForm = new Mveadmin.Northwind.CustomerForm(_this.customerPropertyGrid.idPrefix);
                ...
                new Serenity.Toolbar(_this.byId("CustomerToolbar"), {
                    buttons: [{
                            ...
                            onClick: function () {
                                ...
                                Mveadmin.Northwind.CustomerService.Update({
                                    EntityId: id,
                                    Entity: c
                                }, function (response) {
                                    // reload customer list just in case
                                    Q.reloadLookup(Mveadmin.Northwind.CustomerRow.lookupKey);
                ...
                _this.form.CustomerID.change(function (e) {
                    ...
                    Mveadmin.Northwind.CustomerService.Retrieve({
                        EntityId: customerID
                    }, function (response) {
            ...
            OtherFormInTabDialog.prototype.getCustomerID = function () {
                ...
                return Q.first(Mveadmin.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
            };
        ...
        var PopulateLinkedDataDialog = /** @class */ (function (_super) {
            ...
            function PopulateLinkedDataDialog() {
                ...
                _this.form.CustomerID.changeSelect2(function (e) {
                    ...
                    var id = Q.first(Mveadmin.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == customerID; }).ID;
                    Mveadmin.Northwind.CustomerService.Retrieve({
                        EntityId: id
                    }, function (response) {
            ...
            PopulateLinkedDataDialog.prototype.getIdProperty = function () { return Mveadmin.Northwind.OrderRow.idProperty; };
            PopulateLinkedDataDialog.prototype.getLocalTextPrefix = function () { return Mveadmin.Northwind.OrderRow.localTextPrefix; };
            PopulateLinkedDataDialog.prototype.getNameProperty = function () { return Mveadmin.Northwind.OrderRow.nameProperty; };
            PopulateLinkedDataDialog.prototype.getService = function () { return Mveadmin.Northwind.OrderService.baseUrl; };
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        ...
        }(Mveadmin.Northwind.SupplierDialog));
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        ...
        var ReadOnlyGrid = /** @class */ (function (_super) {
            ...
            return ReadOnlyGrid;
        }(Mveadmin.Northwind.SupplierGrid));
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        ...
        var ResponsiveDialog = /** @class */ (function (_super) {
            ...
            ResponsiveDialog.prototype.getFormKey = function () { return Mveadmin.Northwind.OrderForm.formKey; };
            ResponsiveDialog.prototype.getIdProperty = function () { return Mveadmin.Northwind.OrderRow.idProperty; };
            ResponsiveDialog.prototype.getLocalTextPrefix = function () { return Mveadmin.Northwind.OrderRow.localTextPrefix; };
            ResponsiveDialog.prototype.getNameProperty = function () { return Mveadmin.Northwind.OrderRow.nameProperty; };
            ResponsiveDialog.prototype.getService = function () { return Mveadmin.Northwind.OrderService.baseUrl; };
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        var SerialAutoNumberDialog = /** @class */ (function (_super) {
            ...
            SerialAutoNumberDialog.prototype.getNextNumber = function () {
                ...
                if (!val || val.length <= 1) {
                    ...
                    Mveadmin.Northwind.CustomerService.GetNextNumber({
                        Prefix: prefix,
        ...
        }(Mveadmin.Northwind.CustomerDialog));
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        ...
        }(Mveadmin.Northwind.CustomerGrid));
        ...
        var ChangingLookupTextDialog = /** @class */ (function (_super) {
            ...
            function ChangingLookupTextDialog() {
                ...
                _this.form.ProductID.changeSelect2(function (e) {
                    var productID = Q.toId(_this.form.ProductID.value);
                    if (productID != null) {
                        _this.form.UnitPrice.value = Mveadmin.Northwind.ProductRow.getLookup().itemById[productID].UnitPrice;
                    }
                });
                _this.form.Discount.addValidationRule(_this.uniqueName, function (e) {
                    var price = _this.form.UnitPrice.value;
            ...
            ChangingLookupTextDialog.prototype.getLocalTextPrefix = function () { return Mveadmin.Northwind.OrderDetailRow.localTextPrefix; };
    ...
    (function (BasicSamples) {
        ...
        var ChangingLookupTextEditor = /** @class */ (function (_super) {
            ...
            ChangingLookupTextEditor.prototype.getLookupKey = function () {
                return Mveadmin.Northwind.ProductRow.lookupKey;
            };
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupOrderDetailDialog = /** @class */ (function (_super) {
            ...
            function FilteredLookupOrderDetailDialog() {
                var _this = _super.call(this) || this;
                _this.form = new Mveadmin.Northwind.OrderDetailForm(_this.idPrefix);
        ...
        }(Mveadmin.Northwind.OrderDetailDialog));
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        ...
        }(Mveadmin.Northwind.OrderDetailsEditor));
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        ...
        var FilteredLookupInDetailDialog = /** @class */ (function (_super) {
            ...
            FilteredLookupInDetailDialog.prototype.getIdProperty = function () { return Mveadmin.Northwind.OrderRow.idProperty; };
            FilteredLookupInDetailDialog.prototype.getLocalTextPrefix = function () { return Mveadmin.Northwind.OrderRow.localTextPrefix; };
            FilteredLookupInDetailDialog.prototype.getNameProperty = function () { return Mveadmin.Northwind.OrderRow.nameProperty; };
            FilteredLookupInDetailDialog.prototype.getService = function () { return Mveadmin.Northwind.OrderService.baseUrl; };
    ...
    (function (BasicSamples) {
        ...
        var ProduceSeafoodCategoryEditor = /** @class */ (function (_super) {
            ...
            ProduceSeafoodCategoryEditor.prototype.getLookupKey = function () {
                return Mveadmin.Northwind.CategoryRow.lookupKey;
            };
            /**
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        ...
        }(Mveadmin.Common.BulkServiceAction));
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        var ConditionalFormattingGrid = /** @class */ (function (_super) {
            ...
            ConditionalFormattingGrid.prototype.getDialogType = function () { return Mveadmin.Northwind.ProductDialog; };
            ConditionalFormattingGrid.prototype.getIdProperty = function () { return Mveadmin.Northwind.ProductRow.idProperty; };
            ConditionalFormattingGrid.prototype.getLocalTextPrefix = function () { return Mveadmin.Northwind.ProductRow.localTextPrefix; };
            ConditionalFormattingGrid.prototype.getService = function () { return Mveadmin.Northwind.ProductService.baseUrl; };
            /**
            ...
            CustomLinksInGrid.prototype.onClick = function (e, row, cell) {
                ...
                if (target.hasClass("customer-link")) {
                    ...
                    Q.confirm(message, function () {
                        ...
                        var customer = Q.first(Mveadmin.Northwind.CustomerRow.getLookup().items, function (x) { return x.CustomerID == item.CustomerID; });
                        new Mveadmin.Northwind.CustomerDialog().loadByIdAndOpenDialog(customer.ID);
                    }, {
                        htmlEncode: false,
                        onNo: function () {
                            new Mveadmin.Northwind.OrderDialog().loadByIdAndOpenDialog(item.OrderID);
                        }
                    });
                }
                    ...
                    new Mveadmin.Northwind.OrderDialog().loadEntityAndOpenDialog({
...
(function (Mveadmin) {
    ...
    Mveadmin.SelectableEntityGrid = SelectableEntityGrid;
})(Mveadmin || (Mveadmin = {}));
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        var RowSelectionGrid = /** @class */ (function (_super) {
            ...
            RowSelectionGrid.prototype.getDialogType = function () { return Mveadmin.Northwind.SupplierDialog; };
            RowSelectionGrid.prototype.getIdProperty = function () { return Mveadmin.Northwind.SupplierRow.idProperty; };
            RowSelectionGrid.prototype.getLocalTextPrefix = function () { return Mveadmin.Northwind.SupplierRow.localTextPrefix; };
            RowSelectionGrid.prototype.getService = function () { return Mveadmin.Northwind.SupplierService.baseUrl; };
            RowSelectionGrid = __decorate([
                Serenity.Decorators.registerClass()
            ], RowSelectionGrid);
            return RowSelectionGrid;
        }(Mveadmin.SelectableEntityGrid));
        ...
        var InitialValuesForQuickFilters = /** @class */ (function (_super) {
            ...
            InitialValuesForQuickFilters.prototype.getQuickFilters = function () {
                ...
                Q.first(filters, function (x) { return x.field == "ShippingState" /* ShippingState */; }).init = function (w) {
                    ...
                    w.value = Mveadmin.Northwind.OrderShippingState.NotShipped.toString();
                };
                return filters;
            };
            /**
                ...
                if (target.hasClass('inline-action')) {
                    ...
                    if (target.hasClass('delete-row')) {
                        Q.confirm('Delete record?', function () {
                            Mveadmin.Northwind.CustomerService.Delete({
                                EntityId: item.ID,
                            }, function (response) {
                                _this.refresh();
                            });
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        var InlineImageInGrid = /** @class */ (function (_super) {
            ...
            InlineImageInGrid.prototype.getDialogType = function () { return Mveadmin.Northwind.ProductDialog; };
            InlineImageInGrid.prototype.getIdProperty = function () { return Mveadmin.Northwind.ProductRow.idProperty; };
            InlineImageInGrid.prototype.getLocalTextPrefix = function () { return Mveadmin.Northwind.ProductRow.localTextPrefix; };
            InlineImageInGrid.prototype.getService = function () { return Mveadmin.Northwind.ProductService.baseUrl; };
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        var QuickFilterCustomization = /** @class */ (function (_super) {
            ...
            QuickFilterCustomization.prototype.getDialogType = function () { return Mveadmin.Northwind.OrderDialog; };
            QuickFilterCustomization.prototype.getIdProperty = function () { return Mveadmin.Northwind.OrderRow.idProperty; };
            QuickFilterCustomization.prototype.getLocalTextPrefix = function () { return Mveadmin.Northwind.OrderRow.localTextPrefix; };
            QuickFilterCustomization.prototype.getService = function () { return Mveadmin.Northwind.OrderService.baseUrl; };
            /**
             * This method is called to get list of quick filters to be created for this grid.
             * By default, it returns quick filter objects corresponding to properties that
             * have a [QuickFilter] attribute at server side OrderColumns.cs
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        var CustomerGrossSalesGrid = /** @class */ (function (_super) {
            ...
            CustomerGrossSalesGrid.prototype.getNameProperty = function () { return Mveadmin.Northwind.CustomerGrossSalesRow.nameProperty; };
            CustomerGrossSalesGrid.prototype.getLocalTextPrefix = function () { return Mveadmin.Northwind.CustomerGrossSalesRow.localTextPrefix; };
...
(function (Mveadmin) {
    ...
    (function (BasicSamples) {
        var ViewWithoutIDGrid = /** @class */ (function (_super) {
            ...
            ViewWithoutIDGrid.prototype.getNameProperty = function () { return Mveadmin.Northwind.SalesByCategoryRow.nameProperty; };
            ViewWithoutIDGrid.prototype.getLocalTextPrefix = function () { return Mveadmin.Northwind.SalesByCategoryRow.localTextPrefix; };
            ViewWithoutIDGrid.prototype.getService = function () { return Mveadmin.Northwind.SalesByCategoryService.baseUrl; };
            /**
             * This method is called to preprocess data returned from the list service
             */
...
//# sourceMappingURL=Mveadmin.Web.js.map