...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Mve
        {
            public static class AppEquipmentCommodityRate
            {
                public const string AppEquipmentCommodityRateIndex = "~/Modules/Mve/AppEquipmentCommodityRate/AppEquipmentCommodityRateIndex.cshtml";
            }

            public static class AppEquipmentMarketingCategory
            {
                public const string AppEquipmentMarketingCategoryIndex = "~/Modules/Mve/AppEquipmentMarketingCategory/AppEquipmentMarketingCategoryIndex.cshtml";
            }
        }
